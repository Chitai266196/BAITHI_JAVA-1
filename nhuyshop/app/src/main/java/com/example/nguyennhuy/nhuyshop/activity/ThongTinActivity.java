...
public class ThongTinActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng TruongToiHoc = new LatLng(12.267883, 109.201921);
        mMap.addMarker(new MarkerOptions().position(TruongToiHoc).title("Trường Đại Học Nha Trang").snippet("Tôi đang học ở đây").icon(BitmapDescriptorFactory.defaultMarker()));
        mMap.setMapType(googleMap.MAP_TYPE_NORMAL);
        CameraPosition cameraPosition = new CameraPosition.Builder().target(TruongToiHoc).zoom(90).build();
